...
if (!transferFilters.includes('ALL')) {
    if (!transferFilters.includes('WITHOUT_TRANSFER')) {transferFilteredTickets = allTickets.filter((ticket) => ticket.segments[0].stops.length > 0 && ticket.segments[1].stops.length > 0)}
