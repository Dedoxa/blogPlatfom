...
function App() {
  ...
  const currentTickets = store.getState().tickets;
  ...
  useEffect(() => {
    const sortedTickets = sortTickets(
      currentTickets,
      currentTransferFilters,
      currentPriceFilter,
      currentRenderedTickets
    );
    console.log('sortedTickets.length: ', sortedTickets.length);
  }, [currentTickets, currentTransferFilters, currentPriceFilter, currentRenderedTickets]);
