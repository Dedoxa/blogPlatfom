import changeTranferFilter from './supportFunctions';
...
const checkTransferFilters = (
  ...
  switch (action.type) {
    ...
    case 'WITHOUT_TRANSFER':
      return changeTranferFilter(state, 'WITHOUT_TRANSFER');
    case 'ONE_TRANSFER':
      return changeTranferFilter(state, 'ONE_TRANSFER');
    case 'TWO_TRANSFERS':
      return changeTranferFilter(state, 'TWO_TRANSFERS');
    case 'THREE_TRANSFERS':
      return changeTranferFilter(state, 'THREE_TRANSFERS');
    default:
      return state;
  }
};
