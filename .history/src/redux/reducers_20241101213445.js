import changeTransferFilters from './supportFunctions';
...
const checkTransferFilters = (
  ...
  switch (action.type) {
    ...
    case 'WITHOUT_TRANSFER':
      return changeTransferFilters(state, 'WITHOUT_TRANSFER');
    case 'ONE_TRANSFER':
      return changeTransferFilters(state, 'ONE_TRANSFER');
    case 'TWO_TRANSFERS':
      return changeTransferFilters(state, 'TWO_TRANSFERS');
    case 'THREE_TRANSFERS':
      return changeTransferFilters(state, 'THREE_TRANSFERS');
    default:
      return state;
  }
};
