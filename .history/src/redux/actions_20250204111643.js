...
export const CHANGE_LOGIN_IN_INPUT = (textValue) => ({ type: 'CHANGE_LOGIN_IN_INPUT', value: textValue });
export const CHANGE_PASSWORD_IN_INPUT = (textValue) => ({ type: 'CHANGE_PASSWORD_IN_INPUT', value: textValue });
export const CHANGE_PASSWORD_REPETITION_IN_INPUT = (textValue) => ({ type: 'CHANGE_PASSWORD_REPETITION_IN_INPUT', value: textValue });
