...
export const SHOW_MORE_TICKETS = { type: 'SHOW_MORE_TICKETS' };
export const START_FETCHING = { type: 'START_FETCHING' };
export const STOP_FETCHING = { type: 'STOP_FETCHING' };

//запрос билетов
// export const FETCH_TICKETS_REQUEST = { type: 'FETCH_TICKETS_REQUEST' };
//успешное получение билетов
export const FETCH_TICKETS_SUCCESS = { type: 'FETCH_TICKETS_SUCCESS', response: { data: 'someData' } };
