...
import { setArticlesData, changePasswordInInput, changePasswordRepetitionInInput, setNewCurrentPage, setNewCurrentParticularPage } from './reducers';
...
const store = configureStore({
  reducer: {
    ...
    currentParticularArticle: setNewCurrentParticularPage,
  },
