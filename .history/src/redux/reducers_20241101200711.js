...
const checkTransferFilters = (
  ...
  switch (action.type) {
    ...
    case 'WITHOUT_TRANSFER':
      return state.transferFilters.concat(['WITHOUT_TRANSFER']);
    case 'ONE_TRANSFER':
      return state.transferFilters.concat(['ONE_TRANSFER']);
    case 'TWO_TRANSFERS':
      return state.transferFilters.concat(['TWO_TRANSFERS']);
    case 'THREE_TRANSFERS':
      return state.transferFilters.concat(['THREE_TRANSFERS']);
    default:
      return state;
  }
};
