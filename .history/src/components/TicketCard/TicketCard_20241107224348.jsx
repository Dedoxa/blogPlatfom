...
const TicketCard = (data) => {
  ...
  const toDepartureTime = format(toDate, 'HH:mm');
  const toArrivalTime = format((add(toDepartureTime, {minutes: toDuration})), 'HH:mm');
  ...
  const backDepartureTime = format(backDate, 'HH:mm');
  const backArrivalTime = format((add(backDepartureTime, {minutes: backDuration})), 'HH:mm');;
      ...
      <div className={classes.otherTicketInfo}>
        <div className={classes['infoRow']}>
          <div className={classes['infoTwoLined']}>
            ...
            <div>{toDepartureTime}-00:00</div>
          </div>
          <div className={classes['infoTwoLined']}>
            <div className={classes['titleLine']}>В ПУТИ</div>
            <div>{toDurationHours}ч {toDurationMinutes}м</div>
          </div>
          <div className={classes['infoTwoLined']}>
        ...
        <div className={classes['infoRow']}>
          <div className={classes['infoTwoLined']}>
            ...
            <div>{backDepartureTime}-00:00</div>
          </div>
          <div className={classes['infoTwoLined']}>
            <div className={classes['titleLine']}>В ПУТИ</div>
            <div>{backDurationHours}ч {backDurationMinutes}м</div>
          </div>
          <div className={classes['infoTwoLined']}>
