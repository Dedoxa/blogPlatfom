...
const TicketCard = (data) => {
  ...
  const toArrivalDate = add(toDepartureTime, { years: 0, months: 0, weeks: 0, days: 0, hours: 0, minutes: toDuration, seconds: 0 });
  ...
  const backArrivalDate = add(backDepartureTime, { years: 0, months: 0, weeks: 0, days: 0, hours: 0, minutes: backDuration, seconds: 0 });
