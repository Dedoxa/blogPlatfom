...
const TicketCard = (data) => {
  ...
  const toArrivalTime = format(
    add(toDepartureTime, { years: 0, months: 0, weeks: 0, days: 0, hours: 0, minutes: toDuration, seconds: 0 }),
    'HH:mm'
  );
  ...
  const backArrivalTime = format(
    add(backDepartureTime, { years: 0, months: 0, weeks: 0, days: 0, hours: 0, minutes: backDuration, seconds: 0 }),
    'HH:mm'
  );
