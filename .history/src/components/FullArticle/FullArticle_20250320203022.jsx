...
const FullArticle = () => {
  ...
  const [currentFavoritesCount, changeFavoritesCount] = useState(
    location.state?.currentFavoritesCount ? location.state?.currentFavoritesCount : article?.favoritesCount
  );
