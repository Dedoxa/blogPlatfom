...
const FullArticle = () => {
  ...
  const { data: result, error: fetchingError, isLoading: loadingArticles, } = useGetParticularArticleQuery({ token: userToken, slug: pathname });
  ...
  const [currentFavoritesCount, changeFavoritesCount] = useState(article?.currentFavoritesCount);
