      ...
      <div className={classes.postInfo}>
        <div className={classes.titleAndLikesContainer}>
          ...
          <img
            ...
            onClick={() => {
              if (article.favorited) likeArticle({ path: `/articles/${article.slug}/favorite`, token: userToken });
              if (!article.favorited) unlikeArticle({ path: `/articles/${article.slug}/favorite`, token: userToken });
            }}
          />
