      ...
      {FORM_TYPE === '/sign-up' && (
        <>
          ...
          >
            ...
            {warningsSumm > 0 && <input className={classes.submitDisabledButton} type="submit" value={'Create'} disabled />}
          </form>
        </>
      )}
      {FORM_TYPE === '/profile' && (
        <>
          ...
          >
            ...
            {warningsSumm > 0 && <input className={classes.submitDisabledButton} type="submit" value={'Save'} disabled />}
          </form>
        </>
      )}
      {FORM_TYPE === '/sign-in' && (
