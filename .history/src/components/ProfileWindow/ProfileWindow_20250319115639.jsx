...
const ProfileWindow = () => {
  ...
  useEffect(() => {
    ...
    if (
      ...
      (errors.username?.message || registerResult?.error?.data?.errors?.username)
    ) {
  ...
  }, [registerResult, updateResult, logInResult, pathname, navigate, loginClasses, errors?.username.message]);
