...
const ProfileWindow = () => {
  ...
  const [registerUser, registerResult] = usePostUserMutation();
      ...
      {FORM_TYPE === '/sign-up' && (
        <>
          ...
          >
            ...
            {registerResult?.isSuccess ? (<p className={classes.inputSuccessNotification}>New user is succesfully registered!</p>) : ''}
