...
const ProfileWindow = () => {
  ...
  const isDisabled = errors.password?.message ? true : false;
  const submitButtonClasses = [classes.submitButton];
  if (!submitButtonClasses.includes(classes.submitDisabledButton) && errors.password?.message) submitButtonClasses.push(classes.submitDisabledButton);
  if (submitButtonClasses.includes(classes.submitDisabledButton) && !errors.password?.message) submitButtonClasses.pop();
      ...
      {FORM_TYPE === '/sign-up' && (
        <>
          ...
          >
            ...
            <input className={classes.submitButton} type="submit" value={'Create'} disabled={true} />
