        ...
        <>
          ...
          >
            ...
            <label htmlFor="password">
              <p>Password</p>
              <input
                {...register('password', { required: 'Please fill in the password field.', minLength: 6, maxLength: 40 })}
            ...
            <label htmlFor="passwordRepeat">
              <p>Repeat Password</p>
              <input
                {...register('passwordRepeat', { required: true, minLength: 6, maxLength: 40 })}
            ...
            <label className={classes.agreementBox} htmlFor="agreement">
              <input
                {...register('agreementToPPI', { required: true })}
                type="checkbox"
