...
const ProfileWindow = () => {
  ...
  const totalInputLength = loginInInput.length + passwordInInput.length + passwordRepetitionInInput.length;
      ...
      {FORM_TYPE === '/sign-up' && (
        <>
          ...
          >
            ...
            {(warningsSumm <= 0 && totalInputLength > 0) && <input className={classes.submitButton} type="submit" value={'Create'} />}
            {(warningsSumm > 0 || totalInputLength <= 0) && (
