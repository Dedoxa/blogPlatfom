...
const ProfileWindow = () => {
  ...
  if (!inputClasses.includes(classes.textRedInput) && PasswordInInput.length > 0 && PasswordInInput.length < 6) {
    inputClasses.push(classes.textRedInput);
  } else {
    inputClasses.filter((element) => element === classes.textInput);
  }
          ...
          <form action="#" method="get">
            ...
            <label htmlFor="passwordRepeat">
              ...
              <input
                ...
                type="password"
                placeholder="Password"
                onChange={(value) => store.dispatch({ type: 'CHANGE_PASSWORD_REPETITION_IN_INPUT', value: value.target.value })}
                required
              />
            </label>
