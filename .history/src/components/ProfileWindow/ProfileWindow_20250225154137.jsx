        ...
        <>
          ...
          >
            ...
            <label htmlFor="email">
              <p>Email address</p>
              <input
                {...register('email', { required: 'Please fill in the "Email address" field.' })}
            ...
            <label htmlFor="passwordRepeat">
              <p>Repeat Password</p>
              <input
                {...register('passwordRepeat', { required: 'Please fill in the "Repeat password" field.' })}
            ...
            <label className={classes.agreementBox} htmlFor="agreement">
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <input
                  {...register('agreementToPPI', {
                    required: 'Please check the box and confirm your consent to the terms of data processing.',
                  })}
                  type="checkbox"
              ...
              <div className={classes.inputWarning}>{errors.agreementToPPI?.message}</div>
            </label>
