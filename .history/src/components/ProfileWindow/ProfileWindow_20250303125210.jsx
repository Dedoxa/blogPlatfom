...
import { useLazyRegisterUserMutation, useLazyLoginUserMutation, useLazyUpdateUserMutation } from '../../AppAPI';
...
const ProfileWindow = () => {
  ...
  // const [registerUser, registerResult] = useLazyRegisterUserMutation();
  // const [loginUser, loginResult] = useLazyLoginUserMutation();
  // const [updateUser, updateResult] = useLazyUpdateUserMutation();
        ...
        <>
          ...
          <form
            onSubmit={handleSubmit((data) => {
              ...
              // console.log('Ответ сервера на регистрацию:', registerResult);
            })}
            action="#"
            method="post"
          >
            ...
            <input {...register('submitButton')} type="submit" className={classes.submitButton} value={'Create'} />
