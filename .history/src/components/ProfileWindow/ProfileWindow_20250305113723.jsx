...
const ProfileWindow = () => {
  ...
  }, [registerResult, updateResult, logInResult, pathname, navigate, setError]);
          ...
          >
            <label htmlFor="username">
              ...
              {registerResult.isError && (
                <p className={classes.inputWarning}>{registerResult?.error?.data?.errors?.username}</p>
              )}
            </label>
            <label htmlFor="email">
              <p>Email address</p>
              ...
              {registerResult.isError && (
                <p className={classes.inputWarning}>{registerResult?.error?.data?.errors?.email}</p>
              )}
            </label>
            ...
            <label className={classes.agreementBox} htmlFor="agreement">
              ...
              {registerResult.isError && (
                <p className={classes.inputWarning}>{JSON.stringify(registerResult?.error?.data?.errors)}</p>
              )}
            </label>
        ...
        <>
          ...
          <form
            onSubmit={handleSubmit((data) => {
              ...
              updateUser(window.localStorage.getItem('token'), data);
          ...
          >
            <label htmlFor="username">
              ...
              {updateResult?.error?.data?.errors?.username && (
                <p className={classes.inputWarning}>{JSON.stringify(updateResult?.error?.data?.errors?.username)}</p>
              )}
            </label>
            <label htmlFor="email">
              <p>Email address</p>
              ...
              {updateResult?.error?.data?.errors?.email && (
                <p className={classes.inputWarning}>{JSON.stringify(updateResult?.error?.data?.errors?.email)}</p>
              )}
            </label>
            <label htmlFor="password">
              <p>New password</p>
        ...
        <>
          ...
          >
            ...
            <label htmlFor="password">
              ...
              <p className={classes.inputWarning}>{errors.password?.message}</p>
              {logInResult.isError && (
                <p className={classes.inputWarning}>{JSON.stringify(logInResult?.error?.data?.errors)}</p>
              )}
            </label>
