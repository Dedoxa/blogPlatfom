...
const ProfileWindow = () => {
  ...
  const [registerUser, registerResult, isRegistring] = useRegisterUserMutation();
  const [logInUser, logInResult, isLoggingIn] = useLogInUserMutation();
  const [updateUser, updateResult, isUpdatingUser] = useUpdateUserMutation();
