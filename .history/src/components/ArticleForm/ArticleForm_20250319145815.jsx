...
const ArticleForm = () => {
  ...
  useEffect(() => {
    ...
    if (userName !== article?.author?.username && pathname === `/articles/${slug}/edit`) {
      console.log('userName !== article?.author?.username', userName !== article?.author?.username);
  ...
  }, [createArticleResult, updateArticleResult, slug, pathname, reset, article?.tagList, article?.author?.username, userName, navigate]);
