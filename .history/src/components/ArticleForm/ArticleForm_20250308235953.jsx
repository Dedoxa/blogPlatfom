...
const ArticleForm = () => {
  ...
  }, [createArticleResult, updateArticleResult, pathname, reset, article?.tagList]);
    ...
    <div className={classes.contentBox}>
      ...
      <form
        onSubmit={handleSubmit((data) => {
          ...
          if (pathname === '/articles/:slug/edit') updateArticle({ ...dataObject, path: pathname.replace('/edit', '') });
