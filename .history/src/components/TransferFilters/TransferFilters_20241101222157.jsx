...
const TransferFilters = () => {
  ...
  const oneTransferBoolean = thisTransferFilters.includes('WITHOUT_TRANSFER') ? true : false;
  const twoTransfersBoolean = thisTransferFilters.includes('WITHOUT_TRANSFER') ? true : false;
