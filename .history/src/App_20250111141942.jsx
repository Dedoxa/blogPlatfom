...
import { useGetPostsQuery, useGetParticularArticleQuery } from './AppAPI.js';
...
function App() {
  ...
  const { data: particularArticle, error: particularArticleError, isLoading: loadingParticularArticle } = useGetParticularArticleQuery(currentSlug);
  // const { data: result } = useGetAllPostsQuery();
            ...
            <Routes>
              ...
              <Route
                ...
                render={({ match }) => {
                  ...
                  return <FullArticle articleSlug={slug} />;
                }}
              ></Route>
